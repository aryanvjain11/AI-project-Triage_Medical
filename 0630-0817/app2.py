...
def index():
    try:
        with INDEX2_FILE.open("r", encoding="utf-8") as f:
            return render_template_string(f.read())
    except FileNotFoundError:
        return "Index2.html file not found in execution directory.", 404
...
if __name__ == "__main__":
    Timer(1.0, lambda: webbrowser.open_new("http://127.0.0.1:5001/")).start()
